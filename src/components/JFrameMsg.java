...
public class JFrameMsg extends JComponent implements ActionListener {
	 ...
	 * 
	 * @param title
	 *            Titre de la fenetre d'affichage
	 * @param msg
	 *            Chaine de caracteres a afficher dans la fenetre.
	 */
	 ...
	 * 
	 * @param e
	 *            Evenement appelle (non utilise car unique -> appui sur le
	 *            bouton 'OK')
	...
	/**
	 * Permet a la methode appelante de fermer elle-meme la frame (sans
